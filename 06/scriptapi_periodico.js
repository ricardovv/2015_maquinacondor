...
var urlDiario = 'http://api.nytimes.com/svc/search/v2/articlesearch.json?q=siria&api-key=d16aa54cf90c4d66d6731c0dc50d2d24:1:66460247';
...
// 		document.getElementById("valorPeriodico").innerHTML =  prin(dict.value) ;  
 	//	document.getElementById("valorPeriodico").innerHTML =  "PERIODICO: " + JSON.stringify(  parseInt(dict.value) ) ;  
