...
var getApariciones = 16; //ejemplo para prueba cambio rapido de cantidad de veces palabra mas repetida
var getPalabra = "global";//ejemplo para prueba cambio rapido de palabra mas repetida
...
var counterCargaJSON = 0;
  ...
  // variables globales para nombres
    var   monedaNombre0    	= " el Dólar norteamericano ";
    var   monedaNombre1    	= " el Euro europeo ";
    var   monedaNombre2    	= " el Franco suizo ";
    var   monedaNombre3    	= " el Shéquel israelí ";
    var   monedaNombre4    	= " el Yen Japones ";
    var   monedaNombre5    	= " el Yuan Chino ";
    var   monedaNombre6    	= " la Libra inglesa ";
    var   monedaNombre7    	= " el Rublo ruso ";
    var   monedaNombre8    	= " el Dólar canadiense ";

    var   monedaNombre9		= " el Boliviano ";
	var   monedaNombre10    = " la Libra siria ";
    var   monedaNombre11    = " el Dinar iraquí ";
    var   monedaNombre12   	= " el Afgani afgano ";
    var   monedaNombre13    = " el Peso argentino ";
    var   monedaNombre14    = " el Dinar Libio ";
    var   monedaNombre15    = " la Rupia paquistaní ";
    var   monedaNombre16    = " el Peso Chileno ";
    var   monedaNombre17    = " el Real brasileño ";
    var   monedaNombre18    = " el Guaraní paraguayo ";
    var   monedaNombre19    = " el Peso uruguayo ";
...
var url_data = 'http://apilayer.net/api/live?access_key=5c98ee4b518a69099255b6846ce21102&currencies=USD,EUR,CHF,ILS,JPY,CNY,GBP,RUB,CAD,BOB,SYP,IQD,AFN,ARS,LYD,PKR,CLP,BRL,PYG,UYU&format=1';
...
10 Libra Siria		SYP
11 Dinar Iraqui		IQD
12 Afgani Afgano	AFN
13 Peso Argentino	ARS
14 Dinar Libio		LYD
15 Rupia Paquistan	PKR
16 Peso chileno		CLP
17 Real Brasileno	BRL
18 Guarani Parag	PYG
19 Peso Uruguayo	UYU

USD,EUR,CHF,ILS,JPY,CNY,GBP,RUB,CAD,BOB,SYP,IQD,AFN,ARS,LYD,PKR,CLP,BRL,PYG,UYU,SYP,
- - - - - - - - - - - - */
  ...
  http_request.onreadystatechange = function(){
      if (http_request.readyState == 4  ){
        ...
        monedaValor1 = jsonObj.quotes.USDEUR;  
        monedaValor2 = jsonObj.quotes.USDCHF;  
        monedaValor3 = jsonObj.quotes.USDILS;  
        monedaValor4 = jsonObj.quotes.USDJPY;  
        monedaValor5 = jsonObj.quotes.USDCNY; 
        monedaValor6 = jsonObj.quotes.USDGBP; 
        monedaValor7 = jsonObj.quotes.USDRUB; 
        monedaValor8 = jsonObj.quotes.USDCAD;   

        monedaValor9 = jsonObj.quotes.USDBOB;   
        monedaValor10 = jsonObj.quotes.USDSYP;   
        monedaValor11 = jsonObj.quotes.USDIQD;   
        monedaValor12 = jsonObj.quotes.USDAFN;   
        monedaValor13 = jsonObj.quotes.USDARS;   
        monedaValor14 = jsonObj.quotes.USDLYD;   
        monedaValor15 = jsonObj.quotes.USDPKR;   
        monedaValor16 = jsonObj.quotes.USDCLP;  
        monedaValor17 = jsonObj.quotes.USDBRL;    
        monedaValor18 = jsonObj.quotes.USDPYG;   
        monedaValor19 = jsonObj.quotes.USDUYU;   
...
var categoria1 =  [  
                          ["Bóvedas", "Coyunturas", "Cámaras", "Nervaduras"], 
                          ...
                          ["necronomías", "tanatonomías", "logópedas", "tanatólogos"]
                          ];
 
var categoria2 =  [  
                          ["Arterias", "Membranas", "Tejidos", "Epitelios"], 
                          ["sublinguales", "lacrimales", "musculares", "interiores"], 
                          ["negantrópicas", "norgánicas", "endrogámicas", "negantrópicas"], 
                          ["purulaciones", "expectoraciones", "secreciones", "siquiatrices"], 
...
var categoria4 =  [ 
                          ["Mariposas", "Nínfulos", "Lucíferas", "Crisálidos"], 
...
//array de abajo para pruebas
//var palabrasClave =  ["aba", "abe", "abi", "baba", "bebe", "bibi", "caca", "cece", "cici", "dada", "dede", "didi"];
...
var palabraElegidaQueMasVaria1 =  entregaVariacion(monedaOutput0, monedaValor9, monedaValor10, monedaValor11, monedaValor12); 


// MUESTRA PALABRAS - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
function muestraComparacionMoneda() {
	var muestra = document.getElementById("test");
	salida =	"c1; " + palabraElegidaQueMasVaria1 + 
			"<br> 0% = " + porcentaje[0] + " " + monedaValor1 + 
			"<br> 1% = " + porcentaje[1] + " " + monedaValor2 +
			"<br> 2% = " + porcentaje[2] + " " + monedaValor3 +
			"<br> 3% = " + porcentaje[3] + " " + monedaValor4 +
			"<br> Elige palabra numero = " +  palabraElegidaQueMasVaria1;
...
// crea ventana popup nueva con imagenes y explicacion. 
  ...
  // frase 4 
  tmp.write('El segundo, es que el valor de compra de <a href="http://co.apilayer.net/" target="_blank">' +  monedaNombre7 + ' </a><br> en relación a ' + 
    '<a href="http://co.apilayer.net/" target="_blank">' + monedaNombre2 + 
    '</a> es de<a href="http://co.apilayer.net/" target="_blank"> ' + monedaValor7 + '</a>.'); 
  // cierre divs
  tmp.write('</p></div></div>');
  //jscript para el bg
...
var tiempoRecargaJSON = setInterval(llamaJSON, 10000); //recarga el json 3600000 ms una hora 
var tiempoParaCambiarTodo = 3000;// 20.000 son 20 seg para que recargar todo el poema en su totalidad. 
