...
<head>
	...
	<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600|Open+Sans+Condensed:300,700|Roboto+Condensed|Roboto+Slab' rel='stylesheet' type='text/css'>	<link rel="stylesheet" type="text/css" media="screen" href="_css/style.css">
...
<!-- 
	<button class="button" onclick="cambiaTodo()">Cambia texto</button> 
 -->
...
<!-- 
        <H2>Sobre la Obra</H2>
 -->
        <p><b>Máquina Cóndor</b> es un generador de textos constituido por varios motores de búsqueda y un ‘motor de escritura’. Ahí convergen cuatro variables:</p> 
...
<!-- <a href="" id="envia" onclick="abreVentana()"> | PARA PASAR VALOR | </a> -->
      <div id="poema">
        ...
        <p> quiere <a id="palabra8Div" onclick="abreVentana(8)">obstinada</a> que a sus <a id="palabra9Div" onclick="abreVentana(9)">alas</a> guarde.</p>
      </div> <!--poema -->
 

<div id="test">mamamam</div>
<!--  -->
      <div id="monedas">
        ...
        <div id="moneda17" >Moneda17x</div>  
        <div id="moneda18" >Moneda18x</div>  
        <div id="moneda19" >Moneda19x</div>  
