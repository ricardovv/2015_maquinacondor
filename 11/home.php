...
<body>
Ud. ha ingresado a una página protegida. <a href="logout.php">Cerrar sesión</a>
...
<!-- <a href="" id="envia" onclick="abreVentana()"> | PARA PASAR VALOR | </a> -->
      <div id="poema">
        <p> <a id="palabra1Div" onclick="abreVentana(1)">1Mariposa</a>, no sólo no <a id="palabra2Div" onclick="abreVentana(2)">2cobarde</a> </p>   
        <p> mas <a id="nombreADiv">Nombre01</a>, <a id="palabra3Div" onclick="abreVentana(3)">3temeraria</a>, <a id="palabra4Div" onclick="abreVentana(4)">4fatalmente</a> <a id="palabra5Div" onclick="abreVentana(5)">5ciega,</a></p>
        <p> lo que la <a id="palabra6Div" onclick="abreVentana(6)">6llama</a> al <a id="palabra7Div" onclick="abreVentana(7)">7Fénix</a> aún le niega</p>
        <p> quiere <a id="palabra8Div" onclick="abreVentana(8)">8obstinada</a> que a sus <a id="palabra9Div" onclick="abreVentana(9)">9alas</a> guarde,</p>
      </div> <!--poemacaja -->
 
<!--       <div id="valorPeriodico">ValorPeriodico</div> -->
      <div id="valorMoneda1">valorMoneda1</div>
      <div id="monedas">
        PRUEBA CARGA MONEDAS 
