 ...
 --><div id="cajaOverlay" onclick="cerrar()"> </div>
  ...
  <!--  <button onclick="cambiaTodo()">Cambia texto</button>solo como prueba -->
    ...
    <div id="header"> 
      ...
      <div id="navtop">
        <a class="tooltipHeader" onclick="mostrar(1)">info</a> | <a class="tooltipHeader" onclick="mostrar(2)">artista</a> | <a href="logout.php">salir</a> 
...
<!-- <a href="" id="envia" onclick="abreVentana()"> | PARA PASAR VALOR | </a> -->
      <div id="poema">
        <p> <a id="palabra1Div" onclick="abreVentana(1)">Mariposa</a>, no sólo no <a id="palabra2Div" onclick="abreVentana(2)">cobarde</a> </p>   
        <p> mas <a id="nombreADiv">3341</a>, <a id="palabra3Div" onclick="abreVentana(3)">temeraria</a>, <a id="palabra4Div" onclick="abreVentana(4)">fatalmente</a> <a id="palabra5Div" onclick="abreVentana(5)">ciega,</a></p>
        <p> lo que la <a id="palabra6Div" onclick="abreVentana(6)">llama</a> al <a id="palabra7Div" onclick="abreVentana(7)">Fénix</a> aún le niega</p>
...
<!--       <div id="valorPeriodico">ValorPeriodico</div> -->
      <div id="valorMoneda1">valorMoneda1</div>
      <div id="monedas">
        <div id="moneda0" >Moneda0x</div>
        <div id="moneda1" >Moneda1x</div> 
        ...
        <div >- - - - - - - - - - - - - - - - - - </div>  
        <div id ="monedaSuma" >SUMA TODOx</div>  
    ...
    <div id="counterPoema">
      <p>Dentro de <a id="outputTiempo">x </a> segundos Máquina Condor generará un nuevo poema. Para conocer las razones haga click sobre alguna de las palabras.</p>  
